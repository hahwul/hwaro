...
This performs conservative optimization: HTML comments and trailing whitespace are removed, and JSON/XML whitespace is compacted. All code blocks and content structure are preserved.
